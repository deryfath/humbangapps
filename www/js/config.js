...
db = openDatabase('catatani_db', '1.0', 'Test DB', 5 * 1024 * 1024);
...
function insertSession(userId,username,fullname,address,phone,farmName,email,usertype,comodityType,certificate,image){
    ...
    db.transaction(function (tx) {
      tx.executeSql(query);
      tx.executeSql('INSERT INTO SESSION (id, username, fullname, address, phone, farm_name, comodity_type, certificate, image, email, user_type) VALUES ("'+userId+'", "'+username+'", "'+fullname+'","'+address+'", "'+phone+'", "'+farmName+'","'+comodityType+'","'+certificate+'","'+image+'", "'+email+'", "'+usertype+'")');
      ...
      tx.executeSql(query2,[], function (tx, results){
            if(results.rows.length==1){
              ...
              Template7.global.userdata = {
                ...
                usertype:results.rows.item(0).user_type,
                farm_name:results.rows.item(0).farm_name,
                comodity_type:results.rows.item(0).comodity_type,
                certificate:results.rows.item(0).certificate,
