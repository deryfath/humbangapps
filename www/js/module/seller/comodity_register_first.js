myApp.onPageInit('comodity_register_list', function (page) {
		...
		$('#tab_sembako_comodity_first').click(function(){
			$('.tab-comodity-category-first').removeClass("active");
			$(this).addClass("active");
			document.getElementById('img_sembako_comodity_first').src="img/allbar-blue.png";
			document.getElementById('img_sayur_comodity_first').src="img/vegetablebar.png";
			document.getElementById('img_buah_comodity_first').src="img/fruitbar.png";
			document.getElementById('img_olahan_comodity_first').src="img/olahan.png";
			// loadWidgetComodityChoose(dataDummyJsonSembako);
			// getItemList(4);
			getItemList("item_sembako.json");
		})

		$('#tab_sayur_comodity_first').click(function(){
			$('.tab-comodity-category-first').removeClass("active");
			$(this).addClass("active");
			document.getElementById('img_sembako_comodity_first').src="img/allbar.png";
			document.getElementById('img_sayur_comodity_first').src="img/vegetablebar-blue.png";
			document.getElementById('img_buah_comodity_first').src="img/fruitbar.png";
			document.getElementById('img_olahan_comodity_first').src="img/olahan.png";
		...
		$('#tab_buah_comodity_first').click(function(){
			$('.tab-comodity-category-first').removeClass("active");
			$(this).addClass("active");
			document.getElementById('img_sembako_comodity_first').src="img/allbar.png";
			document.getElementById('img_sayur_comodity_first').src="img/vegetablebar.png";
			document.getElementById('img_buah_comodity_first').src="img/fruitbar-blue.png";
			document.getElementById('img_olahan_comodity_first').src="img/olahan.png";
		...
		$('#tab_olahan_comodity_first').click(function(){
			$('.tab-comodity-category-first').removeClass("active");
			$(this).addClass("active");
			document.getElementById('img_sembako_comodity_first').src="img/allbar.png";
			document.getElementById('img_sayur_comodity_first').src="img/vegetablebar.png";
			document.getElementById('img_buah_comodity_first').src="img/fruitbar.png";
			document.getElementById('img_olahan_comodity_first').src="img/olahan-blue.png";
				    ...
				    tablinks[i].onclick = function(){
						...
						$('.submit-comodity').unbind('click').click(function(){
							...
							if(!sameTypeComodity){
								...
								myApp.alert("Komoditas berhasil disimpan","notifikasi");
					...
					if(document.getElementById(id).checked) {
						...
						$('.submit-comodity').unbind('click').click(function(){
							...
							setTimeout(function(){
								...
								hideLoading();
								// mainView.router.reloadPage('view/seller/comodity_register_first.html');
	...
	$('.next-choose-comodity-first').click(function(){
  		console.log('next');
